...
import com.ilham1012.ecgbpi.activity.RecordNewActivity;
import com.ilham1012.ecgbpi.helper.BitalinoAndroidDevice;
            ...
            switch (msg.what) {
                ...
                case MSG_RECORDING_DURATION:
                    dataManager.setDuration(msg.getData().getString(
                            RecordNewActivity.KEY_DURATION));
                    break;
                default:
...
//                SettingsActivity.KEY_DRAW_IN_BACKGROUND, true);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.e(TAG, "Initialize BITALINO connection");

        String recordingName = intent.getStringExtra(
                RecordNewActivity.KEY_RECORDING_NAME).toString();
        configuration = (DeviceConfiguration) intent
                .getSerializableExtra(RecordNewActivity.KEY_CONFIGURATION);
...
//                .setSmallIcon(R.drawable.notification)
        ...
        Intent newRecordingIntent = new Intent(this, RecordNewActivity.class);
